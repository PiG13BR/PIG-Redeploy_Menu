...
#define COLOR_DARK_GRAY_FADED { 0.1, 0.1, 0.1, 0.75 }
#define COLOR_DARK_BLUE_ALPHA { 0, 0.1, 0.2, 0.8 }

// Base Classes
class redeployMenu_Frame_Base
{
	type = 0;
	idc = -1;
	deletable = 0;
...
class redeployMenu_ListBox_Base
{
	deletable = 0;
	fade = 0;
	access = 0;
...
class redeployMenu_Button_Base
{
	deletable = 0;
	fade = 0;
	access = 0;
